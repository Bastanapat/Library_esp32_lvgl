...
void setup() {
  ...
  // Create a chart
  lv_obj_t *ui_Chart2 = lv_chart_create(lv_scr_act());
  lv_obj_set_width(ui_Chart2, 267);
  lv_obj_set_height(ui_Chart2, 139);
  ...
  lv_chart_series_t* ui_Chart2_series_1 = lv_chart_add_series(ui_Chart2, lv_color_hex(0xFF0202), LV_CHART_AXIS_PRIMARY_Y);
  ...
  // lv_chart_set_next_value(ui_Chart2, ui_Chart2_series_1, 60);
}
